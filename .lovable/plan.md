...
- Janela de alerta passa a ser por tipo: padrão 30 dias (crítico em 10); CR com janela de 180 dias e três faixas de copy (180-121, 120-91, ≤90, com data-limite de protocolo calculada como vencimento menos 90 dias); laudos com janela de 120 dias; mantendo a ordenação da badge pelo item mais urgente.
- Tipos sem validade (nota fiscal recente) ficam fora do motor de alerta da badge — permanecem no Hub e no checklist.
- O bloco "Filiação e atividade CAC" fica pendente de revisão de texto e não será alterado nesta implantação.
