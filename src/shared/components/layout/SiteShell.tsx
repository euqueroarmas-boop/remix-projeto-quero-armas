  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background text-foreground">
      ...
      <header className="fixed inset-x-0 top-0 z-40 border-b border-border/60 bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/85">
        <div className="mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between gap-3 px-4 sm:h-20 sm:px-6 lg:px-8">
      ...
      <footer className="relative z-10 w-full max-w-none border-t border-border/60 bg-surface-overlay">
        <div className="mx-auto grid w-full max-w-[1400px] gap-8 px-4 py-10 sm:grid-cols-2 sm:px-6 sm:py-12 md:grid-cols-3 lg:px-8">
        ...
        <div className="border-t border-border/60">
          <div className="mx-auto w-full max-w-[1400px] px-4 py-4 text-center text-xs text-muted-foreground sm:px-6 lg:px-8">
