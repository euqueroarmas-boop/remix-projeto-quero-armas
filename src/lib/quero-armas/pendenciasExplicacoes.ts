...
const REGISTRO: Record<string, ExplicacaoPendencia> = {
  ...
  certidao_antecedentes_criminais_estadual: {
    ...
    passos: [
      "Clique em \"Acessar site de emissão\" — abre direto o formulário do e-SAJ (TJSP) de Certidão de Distribuição de 1º Grau.",
      "Em \"Foro\", marque \"Todos os Foros\" (não escolha um foro específico, ou a certidão sai incompleta).",
      "Em \"Modelo de Certidão\", selecione \"Ações Criminais, Execuções Criminais, Atos Infracionais e Execuções da Medida Sócio-Educativa\".",
      "Em \"Ações\", marque \"Todas as ações\". Em \"Data Base\", deixe a data de hoje que já vem preenchida.",
      "Em \"Buscar por\", selecione \"Nome\" (é o mais confiável — buscar por CPF pode deixar homônimos de fora).",
      "Preencha: NOME COMPLETO em MAIÚSCULAS igualzinho ao RG, data de nascimento, nome do pai, nome da mãe, RG e CPF.",
      "Digite o código da imagem (captcha) e clique em \"Pesquisar\". A certidão abre em PDF em nova aba.",
      "Baixe pelo ícone de download (seta pra baixo) — não use \"Imprimir → Salvar como PDF\", isso quebra a assinatura digital do TJ.",
      "Confira que aparece seu nome, CPF, \"Todos os Foros\" e o resultado \"NADA CONSTA\".",
      "Volte aqui, clique em \"Entregar documento\" e envie o PDF exatamente como baixado.",
    ],
    observacao: "Validade de 90 dias. Só vale se sair com \"Todos os Foros\" e no modelo criminal — se escolher o modelo cível ou um foro único, a IA reprova. Não escaneie o PDF: envie o original com a assinatura digital.",
  },
  ...
  certidao_tjsp_distribuicao_criminal: {
    ...
    passos: [
      "Clique em \"Acessar site de emissão\" — o botão já abre o e-SAJ do TJSP na página \"Certidão de Distribuição de 1º Grau\".",
      "Em \"Foro\", marque \"Todos os Foros\" (checkbox único acima da lista de foros).",
      "Em \"Modelo de Certidão\", selecione \"Ações Criminais, Execuções Criminais, Atos Infracionais e Execuções da Medida Sócio-Educativa\".",
      "Em \"Ações\", marque \"Todas as ações\". Em \"Data Base\", mantenha a data de hoje.",
      "Em \"Buscar por\", escolha \"Nome\" (evite \"CPF\" — deixa homônimos de fora e a PF pode devolver).",
      "Preencha: NOME COMPLETO em MAIÚSCULAS como no RG, data de nascimento, nome do pai, nome da mãe, RG e CPF.",
      "Digite o código da imagem (captcha) e clique em \"Pesquisar\". O PDF assinado abre em nova aba.",
      "Baixe pelo ícone de download (seta pra baixo). Não use \"Imprimir → Salvar como PDF\" — quebra a assinatura digital.",
      "Volte aqui e clique em \"Entregar documento\".",
    ],
    observacao: "Validade de 90 dias. É a certidão de DISTRIBUIÇÃO — na tela do e-SAJ o campo que muda entre distribuição e execução é o \"Modelo de Certidão\" (aqui é o criminal completo, que já cobre distribuição). Se enviar a de Execuções aqui, a IA reprova.",
  },
  certidao_tjsp_execucoes_criminais: {
    titulo: "TJSP — Execuções criminais",
    passos: [
      "Clique em \"Acessar site de emissão\" — abre o e-SAJ do TJSP, página \"Certidão de Distribuição de 1º Grau\".",
      "Em \"Foro\", marque \"Todos os Foros\".",
      "Em \"Modelo de Certidão\", selecione \"Execuções Criminais\" (é uma opção separada no dropdown — não escolha o modelo de Ações Criminais).",
      "Em \"Ações\", marque \"Todas as ações\". Em \"Data Base\", mantenha a data de hoje.",
      "Em \"Buscar por\", escolha \"Nome\".",
      "Preencha: NOME COMPLETO em MAIÚSCULAS como no RG, data de nascimento, nome do pai, nome da mãe, RG e CPF.",
      "Digite o captcha e clique em \"Pesquisar\". O PDF abre em nova aba.",
      "Baixe pelo ícone de download (seta pra baixo) — nunca via \"Imprimir → PDF\", quebra a assinatura.",
      "Volte aqui e clique em \"Entregar documento\".",
    ],
    observacao: "Validade de 90 dias. Diferente da certidão de Distribuição — o que muda no e-SAJ é o campo \"Modelo de Certidão\": aqui use \"Execuções Criminais\". Se enviar o modelo errado, a IA reprova.",
  },
