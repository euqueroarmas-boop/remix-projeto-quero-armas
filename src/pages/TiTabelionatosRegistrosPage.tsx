...
import heroImg from "@/assets/segments/tabelionato-registros.jpg";

const icons = [Shield, Server, HardDrive, FileCheck, Lock, Activity, AlertTriangle, Headphones];

const TiTabelionatosRegistrosPage = () => {
  const { t } = useTranslation();
  const k = "p.tiRegistros";
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroImage={heroImg}
        heroImageAlt="Ofício de registro com infraestrutura de TI segura e em conformidade"
        ...
        relatedLinks={[
          ...
          { label: relatedLabels[2], href: "/ti-para-tabelionatos-de-protesto" },
          { label: relatedLabels[3], href: "/cartorios/provimento-213" },
          { label: relatedLabels[4], href: "/servidor-dell-poweredge-jacarei" },
...
export default TiTabelionatosRegistrosPage;
