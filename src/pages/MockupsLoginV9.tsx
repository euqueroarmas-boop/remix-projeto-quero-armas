...
export default function MockupsLoginV9() {
  ...
  return (
    <div
      className="relative min-h-[100svh] w-full overflow-x-hidden overflow-y-auto bg-black font-sans text-white lg:min-h-screen lg:overflow-hidden"
      style={{
    ...
    >
      ...
      {/* DIREITA — CARD */}
      <div className="relative z-20 mx-auto flex min-h-[100svh] w-full max-w-[340px] -translate-y-[4svh] flex-col justify-center px-6 py-8 lg:absolute lg:right-[5vw] lg:top-1/2 lg:mx-0 lg:min-h-0 lg:translate-y-[-50%] lg:px-0 lg:py-0">
...
function AppleIcon() {
  return (
    <svg className="h-4 w-4 fill-current text-slate-900" viewBox="0 0 24 24" aria-hidden="true">
