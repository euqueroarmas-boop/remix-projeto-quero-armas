...
export default function QAClientePortalPage() {
        ...
        corpo:
          ehEfetivaNecessidade(rawTipo) && doc?.processo_id && cliente?.id ? (
            ...
            <RequerimentoSinarmRoteiro
              ...
              numeroRequerimento={numeroRequerimentoDeDadosExtraidos(doc?.dados_extraidos_json)}
              onEntregar={() => {
                setEditDocTipo(hubTipo);
                setShowAddDoc(true);
                setShowContratoPopup(false);
  ...
  return (
    ...
    <div className="qa-portal-root min-h-dvh bg-[#F2F2F2] text-slate-900 overflow-x-clip transition-[padding-left] duration-200 pl-0 lg:pl-[200px]">
      ...
      {/* WhatsApp flutuante — dentro da coluna preta, 5mm acima do fim */}
      <a
  ...
  processos: processos.length,
                          ...
                          <button key={p.id} type="button" onClick={() => setActiveSection("processos")}
                            ...
                            <div className="w-full h-1.5 rounded-full bg-slate-100 overflow-hidden">
                              <div className="h-full rounded-full"
                                style={{ width: `${metrics.progresso}%`, background: done ? "#059669" : bad ? "#E24B4A" : "#BA7517" }} />
                            </div>
        ...
        {activeSection === "mensagens" && (
          <ArsenalPremiumGate arsenal={arsenalPremium} recurso="Klal — Assistente Jurídico">
            <div className="-mx-4 lg:-mx-8 h-full min-h-0 pt-[24px] pb-3">
