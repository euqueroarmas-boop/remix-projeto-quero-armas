...
function SectionTitle({ icon: Icon, title, subtitle }: { icon: any; title: string; subtitle?: string }) {
  return (
    <div className="flex items-center gap-2.5 mb-4">
      <div className="h-8 w-8 rounded-lg bg-[#F7F7F8] flex items-center justify-center">
        <Icon className="h-4 w-4 text-[#2F3337]" />
      </div>
      <div>
    ...
    <div className="rounded-xl border border-slate-200/80 bg-white transition-all duration-300 hover:shadow-sm">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          {detailContent && (
            <button className="flex items-center gap-1 text-[10px] font-medium text-[#2F3337] hover:text-[#2F3337] px-2 py-1 rounded-md hover:bg-[#F7F7F8] transition-colors">
  ...
  return (
    <div className="relative">
      <div className="flex items-center gap-1 bg-white border border-slate-200 rounded-xl p-1 shadow-sm">
        ...
        >
          <CalendarDays className="h-4 w-4 text-[#2F3337]" />
        ...
        <>
          ...
          <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-slate-200 rounded-xl shadow-lg z-50 py-1 max-h-64 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-150">
            <button
              ...
              className={`w-full text-left px-4 py-2.5 text-sm transition-colors ${!selected ? "bg-[#F7F7F8] text-[#2F3337] font-semibold" : "text-slate-600 hover:bg-slate-50"}`}
            >
              Todos os meses
            </button>
            {[...months].reverse().map(m => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm transition-colors ${isActive ? "bg-[#F7F7F8] text-[#2F3337] font-semibold" : "text-slate-600 hover:bg-slate-50"}`}
                >
                  {label}
                </button>
              );
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3">
        ...
        <MetricCard label={selectedMonth ? "Receita do Período" : "Receita do Mês"} value={fmt(selectedMonth ? metrics.totalReceita : metrics.thisMonthRev)} icon={TrendingUp}
          color="text-[#2F3337]" bgColor="bg-[#F7F7F8]"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <MetricCard label="Total de Vendas" value={String(metrics.totalVendas)} icon={ShoppingCart}
          color="text-[#2F3337]" bgColor="bg-[#F7F7F8]" subtitle={`${metrics.totalPagas} pagas · ${metrics.totalNaoPagas} não pagas`} />
                ...
                <div key={i} className="p-3 rounded-lg bg-white border border-slate-100">
                  ...
                  <div className="grid grid-cols-4 gap-2 text-[10px]">
                    ...
                    <div className="bg-slate-50 rounded p-2">
                      ...
                      <p className="font-bold text-[#2F3337] mt-0.5">{pct.toFixed(1)}%</p>
                    </div>
                    <div className="bg-slate-50 rounded p-2">
                  ...
                  <div className="mt-2 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                    <div className="h-full bg-[#2F3337] rounded-full" style={{ width: `${pct}%` }} />
                  </div>
                </div>
              );
            })}
                  ...
                  <div key={i} className="group">
                    ...
                    <div className="ml-8.5 mt-1">
                      <div className="h-1 bg-slate-100 rounded-full overflow-hidden">
                        <div className="h-full bg-[#2F3337] rounded-full transition-all group-hover:bg-[#2F3337]" style={{ width: `${pct}%` }} />
                      </div>
                    </div>
                  </div>
                );
