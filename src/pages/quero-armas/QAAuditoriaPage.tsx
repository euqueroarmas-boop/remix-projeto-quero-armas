        ...
        {AUDIT_MODULES.map(m => {
          ...
          const card = (
            <div className={`group h-full p-5 rounded-xl border transition-all ${
              m.available
                ? "bg-white border-slate-200 hover:border-[#2F3337] hover:shadow-md cursor-pointer"
                : "bg-slate-50 border-slate-200 opacity-60 cursor-not-allowed"
            }`}>
              <div className="flex items-start justify-between gap-3">
                <div className="h-9 w-9 rounded-lg flex items-center justify-center bg-slate-100 group-hover:bg-[#26292C] group-hover:text-white transition">
