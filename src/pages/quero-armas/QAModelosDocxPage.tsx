    ...
    <div className="space-y-5 md:space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-xl md:text-2xl font-bold tracking-tight flex items-center gap-2" style={{ color: "hsl(220 20% 18%)" }}>
            <FileText className="h-5 w-5" style={{ color: "hsl(210 8% 20%)" }} /> Modelos DOCX
          </h1>
      ...
      <div className="qa-card p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {VARIAVEIS.map(v => (
            <code key={v} className="text-[10px] px-2 py-1 rounded-lg font-mono" style={{ background: "hsl(220 20% 97%)", color: "hsl(210 8% 20%)", border: "1px solid hsl(220 13% 91%)" }}>{v}</code>
          ))}
        </div>
      </div>
      ...
      {/* New model form */}
      {showForm && (
        <div className="qa-card p-5 space-y-4" style={{ borderColor: "hsl(210 5% 83%)" }}>
