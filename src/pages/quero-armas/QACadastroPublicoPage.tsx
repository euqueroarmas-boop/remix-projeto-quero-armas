  ...
  const submit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        responsavel_endereco_nome: (extracted as any).responsavel_endereco_nome || null,
        responsavel_endereco_cpf: ((extracted as any).responsavel_endereco_cpf || "").replace(/\D/g, "") || null,
        responsavel_endereco_rg_cin: (extracted as any).responsavel_endereco_rg_cin || null,
        responsavel_endereco_telefone: ((extracted as any).responsavel_endereco_telefone || "").replace(/\D/g, "") || null,
        responsavel_endereco_email: (extracted as any).responsavel_endereco_email || null,
        responsavel_endereco_vinculo: (extracted as any).responsavel_endereco_vinculo || null,
        responsavel_endereco_data_nascimento: (extracted as any).responsavel_endereco_data_nascimento || null,
        responsavel_endereco_naturalidade: (extracted as any).responsavel_endereco_naturalidade || null,
        responsavel_endereco_nacionalidade: (extracted as any).responsavel_endereco_nacionalidade || null,
        responsavel_endereco_estado_civil: (extracted as any).responsavel_endereco_estado_civil || null,
        responsavel_endereco_profissao: (extracted as any).responsavel_endereco_profissao || null,
        responsavel_endereco_cep: ((extracted as any).responsavel_endereco_cep || "").replace(/\D/g, "") || null,
        responsavel_endereco_logradouro: (extracted as any).responsavel_endereco_logradouro || null,
        responsavel_endereco_numero: (extracted as any).responsavel_endereco_numero || null,
        responsavel_endereco_complemento: (extracted as any).responsavel_endereco_complemento || null,
        responsavel_endereco_bairro: (extracted as any).responsavel_endereco_bairro || null,
        responsavel_endereco_cidade: (extracted as any).responsavel_endereco_cidade || null,
        responsavel_endereco_estado: (extracted as any).responsavel_endereco_estado || null,
        responsavel_endereco_geolocalizacao: (extracted as any).responsavel_endereco_geolocalizacao || null,
        responsavel_endereco_reside_desde: (extracted as any).responsavel_endereco_reside_desde || null,
        responsavel_endereco_residiu_ate: (extracted as any).responsavel_endereco_residiu_ate || null,
