    ...
    <section className="relative w-full overflow-hidden border-b border-border bg-background py-20 sm:py-28">
      <div className="w-full px-4 text-center sm:px-6 lg:px-10 2xl:px-16">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-base text-muted-foreground sm:text-lg">
          Organize <strong className="text-foreground">suas armas</strong>, <strong className="text-foreground">CR, CRAF, GTE, autorizações</strong>, exames e vencimentos do acervo. <strong className="text-foreground">Você cadastra e envia tudo por conta própria</strong> — a Equipe Quero Armas só entra em ação quando você contratar um serviço. O painel é gratuito; serviços são pagos somente quando você solicitar.
        </p>
