    ...
    <div className="space-y-3">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList className="bg-white border border-slate-200 h-8 w-full">
          <TabsTrigger value="resumo" className="text-[10px] flex-1 data-[state=active]:bg-[#FBF3F4] data-[state=active]:text-[#7A1F2B]">
            <User className="h-3 w-3 mr-1" /> Resumo
          </TabsTrigger>
          <TabsTrigger value="documentos" className="text-[10px] flex-1 data-[state=active]:bg-[#FBF3F4] data-[state=active]:text-[#7A1F2B]">
            <FileText className="h-3 w-3 mr-1" /> Docs ({docs.length})
          </TabsTrigger>
          <TabsTrigger value="peticao" className="text-[10px] flex-1 data-[state=active]:bg-[#FBF3F4] data-[state=active]:text-[#7A1F2B]">
      ...
      <div className="flex flex-wrap gap-1.5 pt-2 border-t border-slate-200">
        {onEdit && (
          <Button size="sm" onClick={() => onEdit(caso.id)}
            className="bg-[#7A1F2B] hover:bg-[#641722] text-white border-0 h-7 text-[10px]">
            Editar / Gerar
          </Button>
        )}
