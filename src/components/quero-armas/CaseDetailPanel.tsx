    ...
    <div className="space-y-3">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList className="bg-white border border-slate-200 h-8 w-full">
          <TabsTrigger value="resumo" className="text-[10px] flex-1 data-[state=active]:bg-[#F7F7F8] data-[state=active]:text-[#2F3337]">
            <User className="h-3 w-3 mr-1" /> Resumo
          </TabsTrigger>
          <TabsTrigger value="documentos" className="text-[10px] flex-1 data-[state=active]:bg-[#F7F7F8] data-[state=active]:text-[#2F3337]">
            <FileText className="h-3 w-3 mr-1" /> Docs ({docs.length})
          </TabsTrigger>
          <TabsTrigger value="peticao" className="text-[10px] flex-1 data-[state=active]:bg-[#F7F7F8] data-[state=active]:text-[#2F3337]">
                  ...
                  <div key={doc.id} className="bg-white border border-slate-200 rounded-lg overflow-hidden">
                    ...
                    {isExpanded && (
                      <div className="border-t border-slate-200 px-3 py-2.5 space-y-3">
                        ...
                        {hasCampos && (
                          <div>
                            <div className="text-[9px] text-[#2F3337] uppercase tracking-[0.12em] mb-1.5 font-semibold">Dados Extraídos</div>
                          ...
                          <div>
                            <div className="flex items-center justify-between mb-1">
                              ...
                              <button
                                ...
                                className="text-[9px] text-slate-400 hover:text-[#2F3337] flex items-center gap-0.5"
                              >
                  ...
                  <div className="flex items-center gap-2">
                    {geracao?.id && (
                      <button
                        ...
                        className="flex items-center gap-1 text-[9px] text-[#2F3337] hover:text-[#2F3337] transition-colors font-medium"
                      >
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-[9px] text-slate-500 hover:text-[#2F3337] transition-colors"
                    >
      ...
      <div className="flex flex-wrap gap-1.5 pt-2 border-t border-slate-200">
        {onEdit && (
          <Button size="sm" onClick={() => onEdit(caso.id)}
            className="bg-[#2F3337] hover:bg-[#26292C] text-white border-0 h-7 text-[10px]">
            Editar / Gerar
          </Button>
        )}
