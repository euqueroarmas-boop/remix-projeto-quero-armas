      ...
      <div className="flex flex-col md:flex-row gap-4 items-start">
        ...
        <div className="flex flex-col gap-2 flex-1 min-w-0">
          ...
          <button
            ...
            onClick={handlePick}
            disabled={saving}
            className="h-9 px-3 rounded-lg bg-[#2F3337] hover:bg-[#26292C] text-white text-[11px] font-semibold uppercase tracking-wider flex items-center gap-2 disabled:opacity-60 w-fit"
          >
