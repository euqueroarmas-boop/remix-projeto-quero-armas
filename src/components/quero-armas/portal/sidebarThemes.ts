...
export function customToTheme(c: QACustomTheme): QASidebarTheme {
  return {
    ...
    //  - rodapé    : segundo gradiente escurece só a parte inferior para
    //                esconder textos da imagem (BRASIL 2026) sem afetar o menu
    bg:
      `linear-gradient(180deg, ` +
        ...
        `rgba(0,0,0,0.55) 100%), ` +
      `linear-gradient(to top, rgba(0,0,0,0.60) 0px, rgba(0,0,0,0.60) 80px, transparent 170px), ` +
