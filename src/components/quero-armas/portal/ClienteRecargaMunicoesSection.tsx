  ...
  return (
    <section className="qa-alvo qa-recarga qa-client-summary-print">
      <style>{`
        ...
        .qa-alvo__head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:16px;flex-shrink:0}
        ...
        @media (max-width:900px){.qa-alvo__grid{grid-template-columns:1fr}.qa-alvo__target{min-height:260px;height:auto}.qa-alvo__cards{grid-template-columns:1fr}}
      `}</style>
