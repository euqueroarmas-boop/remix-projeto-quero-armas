  ...
  return (
    <section className="qa-alvo qa-client-summary-print">
      <style>{`
        ...
        .qa-alvo__note{border:1px solid rgba(47,51,55,.25);background:#fff;border-radius:3px;padding:12px 14px;margin-top:2px}
        ...
        @media (max-width:900px){.qa-alvo__grid{grid-template-columns:1fr;padding:14px}.qa-alvo__target{min-height:340px}.qa-alvo__figure{max-height:400px}.qa-alvo__cards{grid-template-columns:1fr}.qa-alvo__h2{font-size:16px}.qa-alvo__kicker{padding-right:0}}
      `}</style>
