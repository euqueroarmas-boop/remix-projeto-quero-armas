  ...
  return (
    <div className="group flex-1">
      <label className="flex items-center gap-1.5 text-[10px] font-semibold text-slate-500 uppercase tracking-[0.1em] mb-2">
        {Icon && <Icon className="h-3 w-3 text-[#2F3337]" />}
        {label}
      ...
      <Input
        ...
        className="h-10 text-sm bg-slate-50/80 border-slate-200/80 text-slate-800 rounded-lg
          ...
          hover:border-[#D1D3D6] hover:bg-white
          focus-visible:ring-2 focus-visible:ring-[#2F3337] focus-visible:ring-offset-0 focus-visible:border-[#2F3337] focus-visible:bg-white"
      />
    </div>
  );
}
  ...
  return (
    <div className="flex justify-end gap-2.5 pt-5 mt-5 border-t border-slate-100">
      ...
      <Button
        ...
        onClick={onSave}
        disabled={saving}
        className="h-9 px-5 text-xs rounded-md bg-[#2F3337] hover:bg-[#26292C] text-white shadow-sm disabled:opacity-60"
      >
...
export function CrafModal({ open, onClose, onSaved, clienteId, craf }: CrafModalProps) {
  ...
  return (
    <PremiumModalShell open={open} onClose={onClose} title={isEdit ? "Editar CRAF" : "Novo CRAF"} icon={Shield} accentColor="bg-[#2F3337]">
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl bg-slate-50 border border-slate-200/60 p-3 space-y-2 text-xs">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <Input
                ...
                className="h-8 w-24 text-xs text-right bg-white border-slate-300 text-slate-700 px-2 rounded-md font-mono focus-visible:ring-1 focus-visible:ring-[#2F3337] focus-visible:ring-offset-0"
              />
            </div>
            <div className="flex justify-between items-center gap-2 pt-2 border-t border-slate-200/80">
              <span className="text-slate-800 font-bold">Total</span>
              <span className="text-[#2F3337] font-bold font-mono text-sm">R$ {total.toLocaleString('pt-BR')}</span>
            </div>
          </div>
          {/* Actions */}
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button
              ...
              onClick={save}
              disabled={saving}
              className="h-11 text-xs rounded-md bg-[#2F3337] hover:bg-[#26292C] text-white shadow-sm disabled:opacity-60"
            >
              {saving ? <Loader2 className="h-3.5 w-3.5 animate-spin mr-1.5" /> : <Save className="h-3.5 w-3.5 mr-1.5" />}
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="flex-1 min-w-0">
            ...
            <Select value={f.forma_pagamento} onValueChange={v => setF(p => ({ ...p, forma_pagamento: v }))}>
              <SelectTrigger className="h-10 text-sm bg-slate-50/80 border-slate-200/80 text-slate-800 rounded-lg font-medium hover:border-[#D1D3D6] hover:bg-white transition-all duration-200 focus:ring-2 focus:ring-[#2F3337] focus:ring-offset-0 focus:border-[#2F3337]">
        ...
        <div>
          <div className="flex items-center justify-between mb-2.5">
            ...
            <span className="text-[10px] text-[#2F3337] font-bold bg-[#F7F7F8] px-2 py-0.5 rounded-full">{selectedServicos.size} sel.</span>
          </div>
          <Input
            type="text"
            value={servicoSearch}
            ...
            className="h-9 mb-2 text-xs bg-white border-slate-200 text-slate-700 rounded-md focus-visible:ring-1 focus-visible:ring-[#2F3337] focus-visible:ring-offset-0"
          />
              ...
              return orderedKeys.map((groupKey) => {
                ...
                return (
                  <div key={groupKey} className="space-y-1">
                    <div className="sticky top-0 z-10 -mx-2 px-3 py-1 bg-[#2F3337] text-white text-[9px] font-bold uppercase tracking-[0.12em] rounded-md shadow-sm">
                      {groupKey}
              ...
              return (
                <div
                  ...
                  className={`rounded-lg px-2.5 py-2 text-xs transition-all duration-200 ${
                    isChecked
                      ? "bg-[#F7F7F8] border border-[#D1D3D6] text-slate-800 shadow-sm"
                ...
                >
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div className={`h-4 w-4 rounded flex items-center justify-center shrink-0 transition-colors ${
                      isChecked ? "bg-[#2F3337] text-white" : "bg-slate-200"
                    }`}>
                   ...
                   <span className="flex-1 min-w-0 truncate font-medium uppercase">
                    ...
                    {isChecked ? (
                      <Input
                        ...
                        className="h-7 w-16 sm:w-20 text-xs text-right bg-white border-slate-200 text-slate-700 px-1.5 shrink-0 rounded-md focus-visible:ring-1 focus-visible:ring-[#2F3337] focus-visible:ring-offset-0 font-mono disabled:opacity-50 disabled:line-through"
                      />
                    ) : (
...
export function FiliacaoModal({ open, onClose, onSaved, clienteId, filiacao }: FiliacaoModalProps) {
  ...
  return (
    <PremiumModalShell open={open} onClose={onClose} title={isEdit ? "Editar Filiação" : "Nova Filiação"} icon={Users} accentColor="bg-[#2F3337]">
      <div className="space-y-4">
        <div>
          <label className="flex items-center gap-1.5 text-[10px] font-semibold text-slate-500 uppercase tracking-[0.1em] mb-2">
            <Users className="h-3 w-3 text-[#2F3337]" />
            Clube de Tiro
