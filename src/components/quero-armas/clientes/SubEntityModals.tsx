...
function PremiumModalShell({ open, onClose, title, icon: Icon, accentColor, children }: {
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="w-[95vw] max-w-md border-0 shadow-2xl shadow-slate-200/60 rounded-2xl overflow-hidden p-0 bg-white" style={{ maxWidth: "min(95vw, 28rem)" }}>
