      ...
      {file && (
        <div className="pointer-events-none absolute inset-0" style={{ zIndex: 2000 }}>
          <button
            type="button"
            onClick={onRemove}
            className="pointer-events-auto absolute right-2 top-2 flex h-9 w-9 shrink-0 items-center justify-center border-2 border-[#DC2626] bg-white text-[#DC2626] shadow-lg transition-colors hover:bg-[#DC2626] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#DC2626]/40"
            style={{ borderRadius: 4, zIndex: 2001 }}
