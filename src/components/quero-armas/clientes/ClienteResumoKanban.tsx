  ...
  return (
    <main className="qa-client-summary-print">
      <style>{`
        ...
        @keyframes qa-muzzle-glow{0%{filter:drop-shadow(0 0 0 rgba(122,31,43,0))}40%{filter:drop-shadow(0 0 10px rgba(122,31,43,.55))}70%{filter:drop-shadow(0 0 18px rgba(122,31,43,.35))}100%{filter:drop-shadow(0 4px 8px rgba(122,31,43,.35))}}
        ...
        <header className="qa-client-summary-print__top">
          ...
          <div className="qa-client-summary-print__updated">
            ...
            {onOpenCadastro && (
              ...
              >
                <img src="/icone-arma-cadastro.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
              </button>
            )}
          </div>
        </header>
