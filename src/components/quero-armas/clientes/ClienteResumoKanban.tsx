...
export default function ClienteResumoKanban({
  ...
  return (
    <main className="qa-client-summary-print">
      <style>{`
        .qa-client-summary-print{--paper:#f3f3f2;--card:#ffffff;--ink:#111111;--muted:#77777d;--line:#e3e3e1;--bordo:#7A1F2B;--amber:#d5a33d;--green:#278652;--red:#df2727;background:var(--paper);color:var(--ink);font-family:'Arial Narrow',Arial,sans-serif;letter-spacing:.02em;padding:20px 20px 26px;min-height:560px;border:0;border-radius:0;box-shadow:none;text-transform:uppercase}
