...
export default function ClienteResumoKanban({
  ...
  return (
    <main className="qa-client-summary-print">
      ...
      @media (min-width:1025px){.qa-urgbanner__kicker{white-space:nowrap}}.qa-front-card--processos .qa-front-card__item span:first-child{white-space:normal;overflow:visible;overflow-wrap:break-word;word-break:break-word;text-overflow:clip}.qa-front-card--processos .qa-front-card__item strong{white-space:normal;overflow:visible;text-overflow:clip;max-width:none}`}</style>
