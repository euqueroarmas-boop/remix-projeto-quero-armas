        ...
        <header className="qa-client-summary-print__top">
          ...
          <div className="qa-client-summary-print__updated">
            ...
            {onOpenCadastro && (
              ...
              >
                <img src="/icone-arma-cadastro.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'contain', display: 'block' }} />
              </button>
            )}
          </div>
        </header>
