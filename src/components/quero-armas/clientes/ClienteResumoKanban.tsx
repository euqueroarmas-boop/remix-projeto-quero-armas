    ...
    <main className="qa-client-summary-print">
      <style>{`
       ...
       @media (max-width:768px){
         ...
         .qa-client-summary-print__footer{margin-top:64px;padding-bottom:0px;margin-bottom:-14px;font-size:8px}
        }
