...
import EmuAcessoCard from "./EmuAcessoCard";
...
const eventoLabel: Record<string, { label: string; color: string; icon: any }> = {
  ...
  credenciais_enviadas: { label: "Credenciais enviadas", color: "text-[#2F3337] bg-[#F7F7F8]", icon: Send },
...
export default function ClienteAcessoPortal({ cliente }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {hasAccount ? (
        <div className="space-y-4">
          <div className="rounded-2xl border border-[#D1D3D6] bg-[#F7F7F8] p-5">
            <div className="flex items-center gap-2 mb-3">
              <Send className="h-4 w-4 text-[#2F3337]" />
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#2F3337]">Reenviar credenciais</h4>
            </div>
            <p className="text-[11px] text-[#2F3337] mb-3">
              Reenvia o e-mail com a senha temporária atual. Se a senha não estiver mais disponível,
              uma nova será gerada automaticamente.
            </p>
            <Button
              size="sm"
              className="w-full h-9 bg-[#2F3337] hover:bg-[#26292C] text-white text-xs font-bold rounded-xl"
              onClick={handleResend}
              disabled={resendLoading}
            >
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <div className="flex gap-2">
              ...
              <Button
                size="sm"
                className="h-9 shrink-0 bg-[#2F3337] hover:bg-[#26292C] text-white text-xs font-semibold px-4 rounded-xl"
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          <div className="text-center space-y-3">
            ...
            <Button
              className="bg-[#2F3337] hover:bg-[#26292C] text-white text-xs font-bold px-6 h-10 rounded-xl uppercase tracking-wider"
