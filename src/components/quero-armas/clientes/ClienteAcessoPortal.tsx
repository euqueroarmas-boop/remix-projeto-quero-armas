      ...
      {hasAccount ? (
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <div className="flex gap-2">
              ...
              <Button
                size="sm"
                className="h-9 shrink-0 bg-[#7A1F2B] hover:bg-[#641722] text-white text-xs font-semibold px-4 rounded-xl"
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          <div className="text-center space-y-3">
            ...
            <Button
              className="bg-[#7A1F2B] hover:bg-[#641722] text-white text-xs font-bold px-6 h-10 rounded-xl uppercase tracking-wider"
