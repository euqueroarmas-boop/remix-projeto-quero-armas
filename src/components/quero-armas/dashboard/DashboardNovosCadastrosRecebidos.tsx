  ...
  return (
    <div className="qa-card p-4 md:p-6" style={{ background: "#ffffff" }}>
      <div className="flex items-start justify-between mb-4 gap-3 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wide" style={{ color: "hsl(220 20% 18%)" }}>
              Novos Cadastros Recebidos {!loading && <span className="text-[#2F3337]">— {totalPendentes} pendente{totalPendentes !== 1 ? "s" : ""}</span>}
            </h3>
        ...
        <Link to="/clientes" className="text-xs font-medium text-[#2F3337] flex items-center gap-1 hover:underline">
        ...
        {filters.map(f => (
          <button
            ...
            className={`px-3 py-1 rounded-full text-xs font-medium border transition ${
              filter === f.key ? "bg-[#2F3337] text-white border-[#2F3337]" : "bg-white text-slate-600 border-slate-200 hover:border-slate-300"
            }`}
          >
            {f.label}
          </button>
                ...
                <div className="flex flex-wrap items-start gap-3 justify-between">
                  ...
                  <div className="flex flex-col gap-1.5 shrink-0">
                    ...
                    <Link
                      ...
                      className="text-[11px] inline-flex items-center gap-1 px-2 py-1 rounded border border-[#D1D3D6] text-[#2F3337] bg-[#F7F7F8] hover:bg-[#F7F7F8] font-medium"
                    >
                    ...
                    {r.venda && (
                      <Link
                        ...
                        className="text-[11px] inline-flex items-center gap-1 px-2 py-1 rounded border border-[#D1D3D6] text-[#2F3337] bg-[#F7F7F8] hover:bg-[#F7F7F8]"
                      >
