...
const KPI_VARIANTS = {
  ...
  pend:    { dot: "bg-[#2F3337]",   text: "text-[#2F3337]",   ring: "ring-[#2F3337]",   bg: "bg-[#F7F7F8]",   border: "border-[#D1D3D6]",   label: "C/ PEND.",  icon: Users },
} as const;
      ...
      <div className="pl-2 space-y-2">
        ...
        <div className="flex items-start justify-between gap-2 flex-wrap">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
              ...
              {group.temServicoPendente ? (
                <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[9px] font-bold bg-[#F7F7F8] text-[#2F3337] border border-[#D1D3D6]">
            ...
            <Link
              ...
              className="block font-bold text-slate-900 text-[14px] break-words uppercase hover:text-[#2F3337] hover:underline transition-colors"
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <Link
              to={`/clientes?cliente=${group.clienteIdCanonical}&tab=servicos`}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1">
              {group.servicosPendentes.map(({ nome, entidade }) => (
                <span
                  key={nome}
                  className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-semibold bg-[#F7F7F8] text-[#2F3337] border border-[#D1D3D6]"
                >
                  <span
  ...
  return (
    <li className={`rounded-md border ${c.border} ${c.bg} px-2.5 py-1.5`}>
      <div className="flex items-center gap-2 flex-wrap">
        {isPsi
          ? <HeartPulse className="h-3 w-3 text-[#2F3337] shrink-0" />
          : <Crosshair className="h-3 w-3 text-orange-600 shrink-0" />}
        <span className={`text-[10px] font-bold uppercase tracking-wider ${isPsi ? "text-[#2F3337]" : "text-orange-700"}`}>
