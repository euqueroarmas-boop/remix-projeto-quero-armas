...
const CAMPOS_POR_CATEGORIA: Record<(typeof CATEGORIAS_ORDENADAS)[number], Campo[]> = {
  ...
  "Ocupação Lícita (CNPJ)": [
    ...
    { key: "ocupacao_licita_telefone", label: "Telefone" },
    { key: "ocupacao_licita_cep", label: "CEP" },
    { key: "ocupacao_licita_logradouro", label: "Logradouro" },
    { key: "ocupacao_licita_numero", label: "Número" },
    { key: "ocupacao_licita_complemento", label: "Complemento" },
    { key: "ocupacao_licita_bairro", label: "Bairro" },
    { key: "ocupacao_licita_cidade", label: "Cidade" },
    { key: "ocupacao_licita_estado", label: "Estado (UF)" },
  ],
  "Certificado de Registro (CR)": [
