...
const ContactSection = () => {
  return (
    <section id="contato" className="py-24 section-dark">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="font-body text-gunmetal-foreground/70 text-lg max-w-md leading-relaxed mb-8">
          ...
          >
            {[
              ...
              <div key={field.label}>
                <label className="font-mono text-[10px] tracking-[0.2em] uppercase text-primary mb-2 block">
                  {field.label}
                </label>
                <input
                  type={field.type}
                  placeholder={field.placeholder}
                  className="w-full bg-transparent border border-gunmetal-foreground/20 px-4 py-3 font-body text-sm text-gunmetal-foreground placeholder:text-gunmetal-foreground/30 focus:border-primary focus:outline-none transition-colors"
                />
              </div>
            ))}
            <div>
              ...
              <textarea
                ...
                className="w-full bg-transparent border border-gunmetal-foreground/20 px-4 py-3 font-body text-sm text-gunmetal-foreground placeholder:text-gunmetal-foreground/30 focus:border-primary focus:outline-none transition-colors resize-none"
              />
            </div>
            <button
              type="submit"
