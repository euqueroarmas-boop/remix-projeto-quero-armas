// ============================================================================
// danf3eParser.ts
// Parser determinístico para DANF3E (Documento Auxiliar da Nota Fiscal de
// Energia Elétrica Eletrônica). Usado como pré-extração antes de enviar o
// texto para a IA, eliminando alucinações em campos estruturados e garantindo
// que o ENDEREÇO DE ENTREGA (autorativo) nunca seja confundido com o bloco
// de faturamento (que trunca logradouro/complemento por limite de caracteres).
// ============================================================================
