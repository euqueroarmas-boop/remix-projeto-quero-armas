...
const Email = (props: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Orçamento recebido</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}><Text style={brand}>QUERO ARMAS</Text></Section>
        <Container style={card}>
          <Heading style={h1}>Recebemos seu orçamento</Heading>
          <Text style={text}>Olá{props.nome ? `, ${props.nome}` : ''},</Text>
          <Text style={text}>Recebemos sua solicitação de orçamento. Nossa equipe responderá em até 1 dia útil.</Text>
          <Text style={text}><strong>Protocolo:</strong> {props.protocolo}</Text>
          <Section style={{ textAlign: 'center', margin: '28px 0' }}>
            <Button style={button} href={props.portalUrl || 'https://euqueroarmas.com.br'}>Acompanhar</Button>
          </Section>
          <Hr style={hr} />
...
export const template = {
  component: Email,
  subject: 'Orçamento recebido',
  displayName: 'Recebemos seu orçamento',
