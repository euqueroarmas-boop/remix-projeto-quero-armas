...
const Email = (p: Props) => (
  <StatusEmail
    status="ok"
    preview={"Novo comprovante processado"}
    titulo={"Novo comprovante processado"}
    texto={"Um novo comprovante foi lido pela IA e entrou na sua contagem de habitualidade. Confira o novo total de treinos e competi\u00e7\u00f5es v\u00e1lidos."}
    meta={[
      ...
      { label: 'Próxima ação', valor: p.proximaAcao || "Ver contagem atualizada" },
    ]}
...
export const template = {
  component: Email,
  subject: "Novo comprovante entrou na contagem",
  displayName: "Novo comprovante processado",
  previewData: {
    nome: 'CAC',
    nivelAtual: 'Nível 1',
    ...
    proximaAcao: "Ver contagem atualizada",
  },
