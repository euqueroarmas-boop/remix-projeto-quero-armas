...
interface Props {
  nome?: string
  reciboUrl?: string
  valor?: string; data?: string; referencia?: string;
}
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Container style={card}>
          ...
          <Text style={text}>Recebemos seu pagamento. O recibo está disponível no seu portal.</Text>
          <Text style={text}><strong>Valor pago:</strong> R$ {props.valor}<br/><strong>Data:</strong> {props.data}<br/><strong>Referência:</strong> {props.referencia}</Text>
          <Section style={{ textAlign: 'center', margin: '28px 0' }}>
            <Button style={button} href={props.reciboUrl || 'https://euqueroarmas.com.br'}>Ver recibo</Button>
          </Section>
          <Hr style={hr} />
