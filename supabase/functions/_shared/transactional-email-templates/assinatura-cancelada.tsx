...
const Email = (props: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Assinatura cancelada</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}><Text style={brand}>QUERO ARMAS</Text></Section>
        <Container style={card}>
          <Heading style={h1}>Sua assinatura foi cancelada</Heading>
          <Text style={text}>Olá{props.nome ? `, ${props.nome}` : ''},</Text>
          <Text style={text}>Sua assinatura foi cancelada. O acesso ao serviço será encerrado em breve. Se foi engano, reative no portal.</Text>
          
          <Section style={{ textAlign: 'center', margin: '28px 0' }}>
            <Button style={button} href={props.portalUrl || 'https://euqueroarmas.com.br'}>Reativar assinatura</Button>
          </Section>
          <Hr style={hr} />
...
export const template = {
  ...
  displayName: 'Sua assinatura foi cancelada',
