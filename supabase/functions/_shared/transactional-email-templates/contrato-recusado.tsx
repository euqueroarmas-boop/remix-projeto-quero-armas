...
const Email = (props: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Contrato não assinado</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}><Text style={brand}>ARSENAL INTELIGENTE</Text></Section>
        <Container style={card}>
          <Heading style={h1}>Contrato recusado ou expirado</Heading>
          <Text style={text}>Olá{props.nome ? `, ${props.nome}` : ''},</Text>
          <Text style={text}>O contrato não foi assinado dentro do prazo. Caso queira retomar, abra novo orçamento.</Text>
          
          <Section style={{ textAlign: 'center', margin: '28px 0' }}>
            <Button style={button} href={props.contatoUrl || 'https://euqueroarmas.com.br'}>Falar conosco</Button>
          </Section>
          <Hr style={hr} />
...
export const template = {
  component: Email,
  subject: 'Contrato não assinado',
  displayName: 'Contrato recusado ou expirado',
