...
const Email = (props: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Contrato assinado</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Container style={card}>
          ...
          <Text style={text}>O contrato foi assinado por todas as partes. Sua cópia em PDF está disponível abaixo.</Text>
          <Text style={text}><strong>Contrato:</strong> {props.contrato}</Text>
          <Section style={{ textAlign: 'center', margin: '28px 0' }}>
            <Button style={button} href={props.pdfUrl || 'https://euqueroarmas.com.br'}>Baixar PDF</Button>
          </Section>
          <Hr style={hr} />
