...
const passwordBox = { margin: '6px 0 2px', padding: '10px 12px', backgroundColor: '#ffffff', border: '1px solid #e6e3dc', borderRadius: 4, fontFamily: 'Menlo, Consolas, monospace', fontSize: '13px', lineHeight: '20px', fontWeight: 'bold' as const, color: '#7A1F2B', letterSpacing: '0', whiteSpace: 'nowrap' as const, wordBreak: 'keep-all' as const, overflowWrap: 'normal' as const, wordWrap: 'normal' as const, overflowX: 'auto' as const }
