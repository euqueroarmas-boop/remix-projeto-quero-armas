    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Container style={card}>
          ...
          <Text style={text}>A senha da sua conta foi alterada. Se não foi você, redefina imediatamente e nos contate.</Text>
          
          <Section style={{ textAlign: 'center', margin: '28px 0' }}>
            <Button style={button} href={props.resetUrl || 'https://euqueroarmas.com.br'}>Redefinir senha</Button>
          </Section>
          <Hr style={hr} />
...
export const template = {
  ...
  displayName: 'Senha alterada com sucesso',
