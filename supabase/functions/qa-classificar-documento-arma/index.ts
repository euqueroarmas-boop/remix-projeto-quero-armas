...
const SYSTEM_PROMPT = [
  ...
  "  Extrair: nome_completo, cpf, orgao_emissor (ex.: 'Secretaria de Segurança Pública de SP'), data_emissao, data_validade, resultado_certidao.",
  "• ANTECEDENTES_FEDERAL: certidão criminal PF, STF, STJ ou TRF.",
  "  Extrair: nome_completo, cpf, orgao_emissor, data_emissao, data_validade, resultado_certidao.",
  "• ANTECEDENTES_ESTADUAL: certidão criminal de Tribunal de Justiça estadual.",
  "  Extrair: nome_completo, cpf, orgao_emissor (ex.: 'TJ-SP'), data_emissao, data_validade, resultado_certidao.",
  "• ANTECEDENTES_MILITAR: certidão de tribunal militar (TJM, STM).",
  "  Extrair: nome_completo, cpf, orgao_emissor, data_emissao, data_validade, resultado_certidao.",
  "• ANTECEDENTES_ELEITORAL: certidão de quitação eleitoral / crimes eleitorais TSE ou TRE.",
  "  Extrair: nome_completo, cpf, numero_documento (número do título de eleitor — campo 'Número do Título' ou 'Título de Eleitor n.'), orgao_emissor (ex.: 'TSE'), data_emissao, data_validade, resultado_certidao.",
