...
const SYSTEM_PROMPT = [
  ...
  "  Extrair: nome_completo, cpf, data_nascimento, numero_documento (nº RG), orgao_emissor, data_emissao, filiacao_mae, filiacao_pai, naturalidade, nacionalidade, sexo.",
  ...
  "  Extrair: nome_completo, cpf, data_nascimento, numero_documento (nº CIN 9 dígitos), orgao_emissor, data_emissao, data_validade, filiacao_mae, filiacao_pai, naturalidade, nacionalidade, sexo.",
  "• CNH: Carteira Nacional de Habilitação; categorias (A, B, AB…); DETRAN/SENATRAN.",
  "  Extrair: nome_completo, cpf, data_nascimento, numero_documento (nº CNH), numero_registro_cnh, categoria_cnh, orgao_emissor, data_emissao, data_validade, primeira_habilitacao, filiacao_mae, filiacao_pai, naturalidade, sexo.",
  ...
  "REGRA GERAL PARA CERTIDÕES: extraia sempre nome_completo, cpf, data_nascimento, filiacao_mae (nome da mãe conforme constar no documento).",
  "Para resultado_certidao use OBRIGATORIAMENTE 'nada_consta' ou 'consta_apontamento' — nenhum outro valor é aceito.",
  "Esses dados serão confrontados com o cadastro do cliente e com outros documentos aprovados para detectar inconsistências.",
  "• ANTECEDENTES_CRIMINAIS: certidão de antecedentes criminais Polícia Civil estadual.",
  "  Extrair: nome_completo, cpf, data_nascimento, filiacao_mae, orgao_emissor (ex.: 'Secretaria de Segurança Pública de SP'), data_emissao, data_validade, resultado_certidao.",
  "• ANTECEDENTES_FEDERAL: certidão criminal PF, STF, STJ ou TRF.",
  "  Extrair: nome_completo, cpf, data_nascimento, filiacao_mae, orgao_emissor, data_emissao, data_validade, resultado_certidao.",
  "• ANTECEDENTES_ESTADUAL: certidão criminal de Tribunal de Justiça estadual.",
  "  Extrair: nome_completo, cpf, data_nascimento, filiacao_mae, orgao_emissor (ex.: 'TJ-SP'), data_emissao, data_validade, resultado_certidao.",
  ...
  "  Extrair: nome_completo, cpf, data_nascimento, filiacao_mae, numero_documento (número do título de eleitor — campo 'Número do Título' ou 'Título de Eleitor n.'), orgao_emissor (ex.: 'TSE'), data_emissao, data_validade, resultado_certidao.",
  ...
  "  Extrair: nome_completo, cpf, orgao_emissor (nome do clube), data_emissao, data_validade.",
