  ...
  switch (c) {
    ...
    case "autonomo": return [
      {
        ...
        obrigatorio: true,
        link_emissao: "https://www.gov.br/empresas-e-negocios/pt-br/empreendedor",
        label_botao: "Emitir CCMEI",
        instrucoes: "1) Acesse o Portal do Empreendedor (gov.br) com seu login gov.br.\n2) Clique em \"Já sou MEI\" > \"Emitir Certificado CCMEI\".\n3) Baixe o PDF do CCMEI e envie aqui (não envie print de tela).",
        observacoes_cliente: "O CCMEI comprova a sua condição de MEI. Se você é autônomo SEM CNPJ, fale com o operador para definir documento alternativo.",
        orgao_emissor: "Receita Federal / Portal do Empreendedor",
        checklist_operador: [
          "Conferir CPF e nome do titular",
          "Conferir CNPJ e situação ATIVA",
          "Conferir data de emissão do certificado",
          "Verificar ocupação/CNAE declarado",
        ],
      },
      {
        tipo_documento: "renda_cartao_cnpj",
        nome_documento: "Cartão CNPJ (emitido nos últimos 30 dias)",
        obrigatorio: true,
      ...
      },
      {
        ...
        observacoes_cliente: "No MEI o QSA confirma que você é o único titular do CNPJ.",
        orgao_emissor: "Receita Federal",
        prazo_recomendado_dias: 30,
        checklist_operador: [
          "Conferir se o titular consta no quadro",
          "Cruzar com o CCMEI / Cartão CNPJ",
          "Conferir emissão dos últimos 30 dias",
        ],
      },
      {
        ...
        checklist_operador: [
          ...
          "Conferir se a nota foi emitida para um cliente",
    ...
    case "empresario": return [
      ...
      },
      {
        ...
        nome_documento: "Contrato Social, Requerimento de Empresário ou Ficha Cadastral (Junta Comercial)",
        obrigatorio: true,
        link_emissao: "https://www.jucesponline.sp.gov.br/",
        label_botao: "Enviar contrato / requerimento / ficha",
        instrucoes: "1) Acesse a Junta Comercial do seu estado (em SP, a JUCESP).\n2) Baixe UM destes: Contrato Social (última alteração consolidada), Requerimento de Empresário ou Ficha Cadastral Completa.\n3) Envie o documento completo em PDF, com todas as páginas.",
        ...
        checklist_operador: [
          ...
          "Aceitar Ficha Cadastral da Junta como equivalente",
        ],
      },
      {
