...
Deno.serve(async (req) => {
  ...
  // Comprovante é opcional: a confirmação manual pela equipe (botão inline no
  // Kanban / Central de Adesão) não expõe upload de arquivo. A trilha fica em
  // qa_pagamento_auditoria + qa_venda_eventos com ator=staff:<email>.
