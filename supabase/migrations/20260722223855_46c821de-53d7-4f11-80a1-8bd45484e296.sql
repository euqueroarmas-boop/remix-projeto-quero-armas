CREATE TABLE IF NOT EXISTS public.qa_documentos_biblioteca (
  ...
  descricao_o_que_e text,
  descricao_como_enviar text,
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.qa_documentos_biblioteca TO authenticated;
GRANT ALL ON public.qa_documentos_biblioteca TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.qa_servicos_documentos_snapshots TO authenticated;
GRANT ALL ON public.qa_servicos_documentos_snapshots TO service_role;
