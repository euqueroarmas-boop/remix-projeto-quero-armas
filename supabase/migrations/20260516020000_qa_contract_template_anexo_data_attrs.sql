UPDATE qa_contract_templates SET corpo_html = $tpl$<h1>CONTRATO DE PRESTAÇÃO DE SERVIÇOS</h1>
...
<p>As partes acima qualificadas resolvem celebrar o presente CONTRATO DE PRESTAÇÃO DE SERVIÇOS DE ASSESSORIA TÉCNICA E DESPACHO ADMINISTRATIVO, regido pelas seguintes cláusulas e condições, em conformidade com o disposto na Lei nº 10.406/2002 (Código Civil), Lei nº 13.105/2015 (Código de Processo Civil), Lei nº 10.826/2003 (Estatuto do Desarmamento), Decreto nº 11.615/2023, Decreto nº 13.826/2025, Lei nº 8.078/1990 (Código de Defesa do Consumidor), Lei nº 13.709/2018 (Lei Geral de Proteção de Dados), Medida Provisória nº 2.200-2/2001 e Lei nº 14.063/2020.</p>
...
<p>3.5. O prazo de conclusão dos serviços, estimado entre 7 (sete) e 25 (vinte e cinco) dias úteis, conta-se a partir do recebimento, pela CONTRATADA, da totalidade dos documentos válidos e legíveis exigidos pelo checklist do serviço, observadas eventuais exigências adicionais do órgão público competente que escapem ao controle da CONTRATADA, hipótese em que o prazo será suspenso até o saneamento da exigência.</p>
...
<ul>
  ...
  <li>Conferir a documentação enviada pela CONTRATANTE e, quando necessário, solicitar complementação por meio da plataforma;</li>
  ...
  <li>Comunicar à CONTRATANTE, por meio da plataforma e pelos canais oficiais, o andamento do serviço, exigências do órgão público competente e a conclusão de cada etapa;</li>
...
<p>5.1. A CONTRATANTE se obriga a:</p>
<ul>
  ...
  <li>Firmar assinatura digital com certificado ICP-Brasil, padrão A1 ou A3, sempre que exigido para os atos previstos na Cláusula 2.3;</li>
  <li>Pagar pontualmente o valor dos serviços, conforme Cláusula Terceira;</li>
  <li>Arcar com taxas, emolumentos, custas e demais despesas devidas a órgãos públicos, quando aplicáveis;</li>
  ...
  <li>Comunicar imediatamente à CONTRATADA qualquer alteração relevante em sua situação cadastral, financeira ou documental que possa impactar a execução do serviço.</li>
</ul>
<p>5.2. A CONTRATANTE declara, sob as penas da lei, que preenche todos os requisitos legais para a contratação do serviço escolhido, em especial os requisitos do Estatuto do Desarmamento (Lei nº 10.826/2003) e regulamentos vigentes, e que as informações prestadas são verdadeiras.</p>
...
<h2>CLÁUSULA SEXTA --- DO DIREITO DE ARREPENDIMENTO</h2>
<p>6.1. Por se tratar de contratação celebrada à distância, por meio eletrônico, fica assegurado à CONTRATANTE, quando consumidora pessoa física, o direito de arrependimento previsto no art. 49 do Código de Defesa do Consumidor, no prazo de 7 (sete) dias corridos contados da celebração do contrato ou do recebimento do serviço, o que for posterior.</p>
<p>6.2. O exercício do direito de arrependimento deverá ser comunicado à CONTRATADA pelo endereço eletrônico eu@queroarmas.com.br, com identificação do contrato e justificativa expressa, sendo o reembolso processado no prazo de 7 (sete) dias úteis a partir da comunicação válida.</p>
<p>6.3. Caso a CONTRATANTE, no momento do checkout, marque expressamente a opção de início imediato dos serviços --- o que constitui autorização inequívoca para que a CONTRATADA dê início aos atos preparatórios e de despacho antes do esgotamento do prazo de arrependimento --- o reembolso, em caso de arrependimento, será calculado proporcionalmente aos serviços já efetivamente executados pela CONTRATADA até a data da comunicação do arrependimento, conforme demonstrativo enviado à CONTRATANTE, em consonância com a jurisprudência do Superior Tribunal de Justiça.</p>
<p>6.4. Não se aplica o direito de arrependimento à CONTRATANTE pessoa jurídica ou à CONTRATANTE pessoa física que contrate o serviço fora de relação de consumo (art. 2º do CDC), hipótese em que a obrigação se torna irrevogável a partir do aceite eletrônico, ressalvadas as hipóteses de rescisão por culpa previstas nas cláusulas seguintes.</p>
<h2>CLÁUSULA SÉTIMA --- DA RESCISÃO</h2>
<p>7.1. O contrato poderá ser rescindido nas seguintes hipóteses:</p>
<ul>
  ...
  <li>Por recusa, omissão ou demora injustificada da CONTRATANTE em firmar a assinatura ICP-Brasil ou em apresentar documentos essenciais à execução, nos termos das Cláusulas 2.4 e 5.1;</li>
  <li>Por apresentação, pela CONTRATANTE, de informações ou documentos falsos, adulterados ou inexatos, conforme Cláusula 5.3;</li>
...
<p>7.2. Na hipótese de rescisão por culpa da CONTRATANTE, não haverá direito a reembolso dos valores já pagos, ressalvados os casos em que houver expressa previsão legal em sentido diverso.</p>
<p>7.3. Na hipótese de rescisão por culpa da CONTRATADA, esta restituirá à CONTRATANTE os valores pagos proporcionalmente aos serviços não executados, no prazo de 15 (quinze) dias úteis.</p>
<h2>CLÁUSULA OITAVA --- DA RESPONSABILIDADE E DOS LIMITES</h2>
<p>8.1. A CONTRATADA atua mediante obrigação de meio, e não de resultado, no que se refere ao deferimento dos pedidos pelos órgãos públicos competentes. A decisão final de cada órgão (PF, Exército, gov.br ou outro) é discricionária da Administração Pública e não pode ser garantida pela CONTRATADA.</p>
<p>8.2. A CONTRATADA não se responsabiliza por:</p>
<ul>
...
<p>8.3. A responsabilidade da CONTRATADA, em qualquer hipótese, fica limitada ao valor efetivamente recebido pela prestação do serviço específico em discussão, salvo nos casos de dolo ou culpa grave devidamente comprovados.</p>
<h2>CLÁUSULA NONA --- DA PROTEÇÃO DE DADOS PESSOAIS (LGPD)</h2>
<p>9.1. As partes obrigam-se a observar as disposições da Lei nº 13.709/2018 (Lei Geral de Proteção de Dados --- LGPD).</p>
<p>9.2. A CONTRATADA, na condição de controladora dos dados pessoais da CONTRATANTE, tratará tais dados exclusivamente para as finalidades de:</p>
<ul>
...
<p>9.3. Os dados pessoais serão armazenados por prazo compatível com as finalidades acima e com a legislação aplicável, em ambiente seguro, com acesso restrito a colaboradores autorizados.</p>
<p>9.4. A CONTRATANTE poderá, a qualquer tempo, exercer os direitos previstos no art. 18 da LGPD (confirmação, acesso, correção, anonimização, portabilidade, eliminação, oposição), mediante solicitação ao endereço eletrônico eu@queroarmas.com.br.</p>
<p>9.5. A CONTRATANTE autoriza expressamente o compartilhamento de seus dados pessoais e documentos com (i) órgãos públicos competentes para a execução do despacho contratado, (ii) o gateway de pagamentos Asaas para o processamento das cobranças, (iii) o advogado parceiro, quando aplicável, na hipótese da Cláusula 1.3, e (iv) operadores e prestadores de serviço da CONTRATADA, em observância à LGPD.</p>
<h2>CLÁUSULA DÉCIMA --- DA COMUNICAÇÃO E DAS NOTIFICAÇÕES</h2>
<p>10.1. Todas as comunicações entre as partes serão realizadas preferencialmente pela plataforma da CONTRATADA e pelos seguintes canais oficiais:</p>
<ul>
  <li>E-mail oficial da CONTRATADA: eu@queroarmas.com.br;</li>
  <li>Telefone comercial / WhatsApp: (11) 97848-1919;</li>
  <li>Endereço cadastrado da CONTRATANTE na plataforma.</li>
</ul>
<p>10.2. Considera-se validamente entregue a comunicação enviada ao endereço eletrônico ou ao número de contato informado pela CONTRATANTE no momento do cadastro, sendo de sua responsabilidade mantê-los atualizados.</p>
<h2>CLÁUSULA DÉCIMA PRIMEIRA --- DA PROPRIEDADE INTELECTUAL E DO USO DA PLATAFORMA</h2>
<p>11.1. Todos os direitos relativos à plataforma https://www.euqueroarmas.com.br, incluindo marcas, logotipos, layout, textos, software, fluxos de cadastro e materiais didáticos, pertencem exclusivamente à CONTRATADA ou a seus licenciantes, sendo vedada à CONTRATANTE qualquer forma de reprodução, distribuição ou exploração comercial sem autorização expressa e por escrito.</p>
<p>11.2. O acesso da CONTRATANTE à plataforma é pessoal e intransferível, sendo de sua responsabilidade a guarda das credenciais de acesso.</p>
<h2>CLÁUSULA DÉCIMA SEGUNDA --- DAS DISPOSIÇÕES GERAIS</h2>
<p>12.1. Este contrato representa a integralidade do acordo entre as partes e prevalece sobre quaisquer entendimentos anteriores, verbais ou escritos, relativos ao seu objeto.</p>
<p>12.2. A eventual tolerância da CONTRATADA quanto ao descumprimento de qualquer cláusula deste contrato pela CONTRATANTE não importará em novação, transação ou renúncia ao direito ou faculdade respectiva.</p>
<p>12.3. A nulidade de qualquer cláusula deste contrato não comprometerá a validade das demais, que permanecerão plenamente eficazes.</p>
<p>12.4. Este contrato obriga as partes, seus herdeiros e sucessores a qualquer título.</p>
<p>12.5. As alterações ao presente contrato dependerão de aceite eletrônico expresso da CONTRATANTE na plataforma, sendo informadas com antecedência mínima de 15 (quinze) dias.</p>
<h2>CLÁUSULA DÉCIMA TERCEIRA --- DO FORO</h2>
<p>13.1. Fica eleito o foro da Comarca de Jacareí, Estado de São Paulo, com renúncia expressa a qualquer outro, por mais privilegiado que seja, para dirimir quaisquer questões oriundas do presente contrato.</p>
<p>13.2. Tratando-se de relação de consumo (art. 2º e art. 3º da Lei nº 8.078/1990), prevalecerá o foro do domicílio do consumidor, nos termos do art. 101, inciso I, do Código de Defesa do Consumidor.</p>
...
<section data-anexo-slug="operador-de-pistola-nivel-i">
...
<section data-anexo-slug="vip-operador-de-pistola-nivel-i">
...
<section data-anexo-slug="apostilamento-atualizacao">
...
<section data-anexo-slug="autorizacao-de-compra-de-arma-de-fogo-atirador-esportivo-cac">
...
<section data-anexo-slug="autorizacao-de-compra-de-arma-de-fogo-para-cacador-cac">
...
<section data-anexo-slug="guia-de-trafego-especial-cac">
...
<section data-anexo-slug="registro-e-apostilamento-de-arma-de-fogo-cac">
...
<section data-anexo-slug="renovacao-cr">
...
<section data-anexo-slug="mudanca-servico">
...
<section data-anexo-slug="posse-de-arma-de-fogo">
...
<section data-anexo-slug="mandado-de-seguranca">
...
<section data-anexo-slug="porte-arma-fogo">
...
<section data-anexo-slug="recurso-administrativo">
...
<section data-anexo-slug="registro-arma-fogo">
...
<section data-anexo-slug="renovacao-de-porte-de-arma-de-fogo">
...
<section data-anexo-slug="renovacao-posse-de-arma-de-fogo">
...
$tpl$, updated_at = now() WHERE codigo='CONTRATO_PRINCIPAL_MVP_QUERO_ARMAS';

UPDATE qa_homologacao_sessoes
SET etapa = 'cadastro_unificado_6_etapas_e_anexo_filtrado',
    payload = payload || '{"cadastro_unificado_6_etapas": true, "etapa_00_escolha_guiada_integrada": true, "cadastro_v2_redirect": true, "anexo_i_filtrado_por_servico": true, "template_canonico_preservado_com_data_attributes": true}'::jsonb,
    observacoes = observacoes || ' | Cadastro v2 integrado ao /cadastro como Etapa 00 (fluxo unico de 6 etapas). Anexo I do contrato agora exibe APENAS o servico contratado (filtragem por data-anexo-slug no ContractPreviewCard). Template canonico em qa_contract_templates preservado com os 18 anexos para referencia interna.'
