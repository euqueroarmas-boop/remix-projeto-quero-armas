-- Adiciona <section data-anexo-slug="..."> em cada anexo do template
-- CONTRATO_PRINCIPAL_MVP_QUERO_ARMAS para permitir filtro do Anexo I
-- correspondente ao serviço contratado. Conteúdo dos anexos preservado.
