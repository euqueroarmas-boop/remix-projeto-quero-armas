UPDATE public.qa_checklist_grupos SET slug='laudos', nome='Laudos', updated_at=now() WHERE slug='saude';

UPDATE public.qa_servicos_documentos
SET regra_validacao = jsonb_set(regra_validacao, '{grupo_checklist}', '"laudos"'::jsonb)
WHERE regra_validacao->>'grupo_checklist' = 'saude';
...
GRANT EXECUTE ON FUNCTION public.qa_painel_progresso_clientes() TO service_role;