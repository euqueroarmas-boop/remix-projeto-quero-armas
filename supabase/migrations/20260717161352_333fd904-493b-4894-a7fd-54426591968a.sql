...
-- Ajusta o gatilho para também recuperar slots de processo em status 'rejeitado'
-- quando um novo documento aprovado no Hub cobre a mesma exigência.
-- Causa raiz: slots rejeitados manualmente ficavam órfãos e o assistente
-- pedia o documento de novo mesmo com o Hub já satisfeito.
...
-- Reaplica satisfação para o cliente 189: retoca todos os comprovantes aprovados,
-- o que dispara o trigger e reaproveita para quaisquer slots (inclusive rejeitados).
