...
ALTER TABLE public.qa_documentos_cliente ADD CONSTRAINT qa_doc_cliente_tipo_check CHECK (tipo_documento = ANY (ARRAY[
 ...
 'antecedentes_criminais','antecedentes_federal','antecedentes_federal_trf3_regional',
 'antecedentes_federal_sjsp_jef','antecedentes_estadual','antecedentes_estadual_distribuicao',
 ...
 'comprovante_clube_tiro','comprovante_competicao','comprovante_pagamento',
