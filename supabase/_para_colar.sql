-- ############################################################################
-- PARA COLAR NO SQL EDITOR DO SUPABASE — Bloco 8 (17/08/2026) — v2
-- ----------------------------------------------------------------------------
...
--
-- v2 — correcao: qa_cliente_armas e VIEW (une qa_crafs + qa_cliente_armas_manual)
-- e Postgres nao aceita gatilho de linha em view. Agora usamos as tabelas-base
-- e o bloco pula sozinho qualquer relacao que nao seja tabela.
--
