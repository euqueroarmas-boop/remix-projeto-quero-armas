...
- [Retomada do Checklist Guiado](mem://features/quero-armas/retomada-checklist-guiado) — Sair da tela ou fechar o navegador não perde o lugar: localStorage por cliente guarda seção, pendência e rolagem (7 dias), sempre revalidados contra a fila real
