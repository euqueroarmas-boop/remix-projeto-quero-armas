...
**PASSA TUDO PELO POP-UP GUIADO.** Toda comunicação e toda exigência dirigida ao cliente acontece DENTRO do `PendenciasGuiadasPopup`. Proibido segundo pop-up por cima, tela solta, ou e-mail como canal único — o e-mail avisa, o guiado é onde ele age. Fluxo com tela própria entra por `corpo: React.ReactNode` (moldes: EfetivaNecessidadeModal, AcessoGovBrPanel, RequerimentoSinarmRoteiro, JuntadaAssinaturaPanel). Exigência sem item na fila é exigência não cumprida. Ver mem://constraints/quero-armas-popup-guiado-canal-do-cliente.
...
- [Pop-up guiado é o canal do cliente](mem://constraints/quero-armas-popup-guiado-canal-do-cliente) — Comunicação e exigência ao cliente SEMPRE dentro do guiado; `corpo` para fluxo com tela própria; e-mail avisa, guiado é onde se age
...
- [Comprovante de Pagamento](mem://features/quero-armas/comprovante-pagamento-pertence-ao-contrato) — Comprovante de pagamento pertence ao CONTRATO (jurídico); só a GRU pertence ao processo.
- [Checklist Grupos Canônicos](mem://features/quero-armas/checklist-grupos-canonicos) — antecedentes_* = Idoneidade, certidão federal em 2 abrangências (TRF3 regional + SJSP/JEF), acervo só para serviços CAC
